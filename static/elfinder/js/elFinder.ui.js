	...
	upload : function(fm) {
		...
		this.exec = function() {
			...
			var id = 'el-finder-io-'+(new Date().getTime()),
				...
				f = k + '<form method="post" enctype="multipart/form-data" action="'+self.fm.options.url+'" target="'+id+'"><input type="hidden" name="cmd" value="upload" /><input type="hidden" name="current" value="'+self.fm.cwd.hash+'" />',
				d = $('<div/>'),
				i = 1;
				alert(jj);
