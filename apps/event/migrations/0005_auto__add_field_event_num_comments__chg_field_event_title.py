...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('event_event', 'num_comments', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Changing field 'Event.title'
        db.alter_column('event_event', 'title', self.gf('django.db.models.fields.CharField')(max_length=300))


    def backwards(self, orm):
        
        # Deleting field 'Event.num_comments'
        db.delete_column('event_event', 'num_comments')

        # Changing field 'Event.title'
        db.alter_column('event_event', 'title', self.gf('django.db.models.fields.CharField')(max_length=80))
