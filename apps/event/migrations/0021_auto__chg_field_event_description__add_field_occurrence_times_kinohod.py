...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('event_event', 'description', self.gf('tinymce.models.HTMLField')())

        # Adding field 'Occurrence.times_kinohod'
        db.add_column('event_occurrence', 'times_kinohod', self.gf('event.fields.TimelistField')(max_length=288, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Occurrence.times_kinohod'
        db.delete_column('event_occurrence', 'times_kinohod')
    ...
    models = {
        ...
        'event.occurrence': {
            ...
            'times_kinohod': ('event.fields.TimelistField', [], {'max_length': '288', 'null': 'True', 'blank': 'True'})
        },
        'place.place': {
