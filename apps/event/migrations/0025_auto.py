...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sites on 'Occurrence'
        db.create_table('event_occurrence_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('occurrence', models.ForeignKey(orm['event.occurrence'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('event_occurrence_sites', ['occurrence_id', 'site_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field sites on 'Occurrence'
        db.delete_table('event_occurrence_sites')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 8, 13, 13, 13, 860401)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 8, 13, 13, 13, 860162)'}),
