...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SoonEvent'
        db.create_table('event_soonevent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.OneToOneField')(related_name='soon_flag', unique=True, to=orm['event.Event'])),
        ))
        db.send_create_signal('event', ['SoonEvent'])

        # Adding M2M table for field sites on 'SoonEvent'
        db.create_table('event_soonevent_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('soonevent', models.ForeignKey(orm['event.soonevent'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('event_soonevent_sites', ['soonevent_id', 'site_id'])


    def backwards(self, orm):
        
        # Deleting model 'SoonEvent'
        db.delete_table('event_soonevent')

        # Removing M2M table for field sites on 'SoonEvent'
        db.delete_table('event_soonevent_sites')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 12, 20, 35, 50, 762992)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 12, 20, 35, 50, 762752)'}),
        ...
        'event.soonevent': {
            'Meta': {'object_name': 'SoonEvent'},
            'event': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'soon_flag'", 'unique': 'True', 'to': "orm['event.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sites.Site']", 'null': 'True', 'blank': 'True'})
        },
        'event.todayevent': {
            'Meta': {'object_name': 'TodayEvent'},
            'event': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'today_flag'", 'unique': 'True', 'to': "orm['event.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sites.Site']", 'null': 'True', 'blank': 'True'})
        },
