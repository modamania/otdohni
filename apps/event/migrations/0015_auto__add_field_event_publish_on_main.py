...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.publish_on_main'
        db.add_column('event_event', 'publish_on_main', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.publish_on_main'
        db.delete_column('event_event', 'publish_on_main')
