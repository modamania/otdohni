...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Occurrence.repeat_weekday'
        db.alter_column('event_occurrence', 'repeat_weekday', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=20, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.description'
        db.alter_column('event_event', 'description', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'Occurrence.repeat_weekday'
        db.alter_column('event_occurrence', 'repeat_weekday', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
