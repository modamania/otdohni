...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.kinohod_id'
        db.add_column('event_event', 'kinohod_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.kinohod_id'
        db.delete_column('event_event', 'kinohod_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 14, 2, 31, 772422)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 14, 2, 31, 772183)'}),
        ...
        'event.event': {
            ...
            'kinohod_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
