...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventCategory.order'
        db.add_column('event_eventcategory', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventCategory.order'
        db.delete_column('event_eventcategory', 'order')
