...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Occurrence.start_times'
        db.alter_column('event_occurrence', 'start_times', self.gf('event.fields.TimelistField')(max_length=288, null=True))


    def backwards(self, orm):
        
        # Changing field 'Occurrence.start_times'
        db.alter_column('event_occurrence', 'start_times', self.gf('event.fields.TimelistField')(max_length=144, null=True))
