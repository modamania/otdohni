...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Occurrence.repeat_weekday'
        db.add_column('event_occurrence', 'repeat_weekday', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Changing field 'Occurrence.repeat_every'
        db.alter_column('event_occurrence', 'repeat_every', self.gf('django.db.models.fields.IntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Occurrence.repeat_weekday'
        db.delete_column('event_occurrence', 'repeat_weekday')

        # Changing field 'Occurrence.repeat_every'
        db.alter_column('event_occurrence', 'repeat_every', self.gf('event.fields.TimedeltaField')(null=True))
