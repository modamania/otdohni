...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.soon'
        db.add_column('event_event', 'soon', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.soon'
        db.delete_column('event_event', 'soon')
    ...
    models = {
        ...
        'event.event': {
            ...
            'soon': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
