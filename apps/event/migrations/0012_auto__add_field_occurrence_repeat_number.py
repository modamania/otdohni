...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Occurrence.repeat_number'
        db.add_column('event_occurrence', 'repeat_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Occurrence.repeat_number'
        db.delete_column('event_occurrence', 'repeat_number')
