...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventCategory.category_mean'
        db.add_column('event_eventcategory', 'category_mean', self.gf('django.db.models.fields.FloatField')(default=1.0, null=True, blank=True), keep_default=False)

        # Adding field 'EventCategory.rating_title'
        db.add_column('event_eventcategory', 'rating_title', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)

        # Adding field 'Event.rate'
        db.add_column('event_event', 'rate', self.gf('django.db.models.fields.FloatField')(default=1, max_length=10), keep_default=False)

        # Adding field 'Event.num_votes'
        db.add_column('event_event', 'num_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventCategory.category_mean'
        db.delete_column('event_eventcategory', 'category_mean')

        # Deleting field 'EventCategory.rating_title'
        db.delete_column('event_eventcategory', 'rating_title')

        # Deleting field 'Event.rate'
        db.delete_column('event_event', 'rate')

        # Deleting field 'Event.num_votes'
        db.delete_column('event_event', 'num_votes')
