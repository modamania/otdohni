...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TodayEvent'
        db.create_table('event_todayevent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['event.Event'], unique=True)),
        ))
        db.send_create_signal('event', ['TodayEvent'])

        # Adding M2M table for field sites on 'TodayEvent'
        db.create_table('event_todayevent_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('todayevent', models.ForeignKey(orm['event.todayevent'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('event_todayevent_sites', ['todayevent_id', 'site_id'])


    def backwards(self, orm):
        
        # Deleting model 'TodayEvent'
        db.delete_table('event_todayevent')

        # Removing M2M table for field sites on 'TodayEvent'
        db.delete_table('event_todayevent_sites')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 12, 16, 41, 17, 274969)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 12, 16, 41, 17, 274720)'}),
        ...
        'event.todayevent': {
            ...
            'event': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['event.Event']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['sites.Site']", 'null': 'True', 'blank': 'True'})
        },
