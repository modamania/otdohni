...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for e in orm.Event.objects.all():
            try:
                dt = e.periods.all().order_by('start_date')[0]
            except IndexError:
                continue
            else:
                e.start_date = dt.start_date
                e.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 12, 15, 2, 51, 539381)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 12, 15, 2, 51, 539138)'}),
