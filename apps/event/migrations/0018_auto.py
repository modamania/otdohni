...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('event_eventcategory_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('eventcategory', models.ForeignKey(orm['event.eventcategory'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('event_eventcategory_sites', ['eventcategory_id', 'site_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field sites on 'EventCategory'
        db.delete_table('event_eventcategory_sites')
