...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PhotoReport.place_event'
        db.delete_column('photoreport_photoreport', 'place_event_id')

        # Adding field 'PhotoReport.event'
        db.add_column('photoreport_photoreport', 'event', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='photoreports', null=True, blank=True, to=orm['event.Event']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PhotoReport.place_event'
        db.add_column('photoreport_photoreport', 'place_event', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='photoreports', to=orm['place.Place']), keep_default=False)

        # Deleting field 'PhotoReport.event'
        db.delete_column('photoreport_photoreport', 'event_id')
    ...
    models = {
        ...
        'photoreport.photoreport': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'photoreports'", 'null': 'True', 'blank': 'True', 'to': "orm['event.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
