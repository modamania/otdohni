...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PhotoReport.place'
        db.add_column('photoreport_photoreport', 'place', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='photoreports', null=True, to=orm['place.Place']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PhotoReport.place'
        db.delete_column('photoreport_photoreport', 'place_id')
