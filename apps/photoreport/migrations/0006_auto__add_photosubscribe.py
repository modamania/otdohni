...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PhotoSubscribe'
        db.create_table('photoreport_photosubscribe', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photoreport.Photo'])),
        ))
        db.send_create_signal('photoreport', ['PhotoSubscribe'])


    def backwards(self, orm):
        
        # Deleting model 'PhotoSubscribe'
        db.delete_table('photoreport_photosubscribe')
    ...
    models = {
        ...
        'photoreport.photosubscribe': {
            'Meta': {'object_name': 'PhotoSubscribe'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['photoreport.Photo']"}),
