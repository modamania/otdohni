...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlaceUpdate.place'
        db.alter_column('graber_placeupdate', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['place.Place']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PlaceUpdate.place'
        raise RuntimeError("Cannot reverse this migration. 'PlaceUpdate.place' and its values cannot be restored.")
