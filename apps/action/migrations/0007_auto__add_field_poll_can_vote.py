...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Poll.can_vote'
        db.add_column('action_poll', 'can_vote', self.gf('django.db.models.fields.CharField')(default='ALL', max_length=10), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Poll.can_vote'
        db.delete_column('action_poll', 'can_vote')
