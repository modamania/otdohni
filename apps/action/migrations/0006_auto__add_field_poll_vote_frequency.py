...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Poll.vote_frequency'
        db.add_column('action_poll', 'vote_frequency', self.gf('django.db.models.fields.CharField')(default='ONCE', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Poll.vote_frequency'
        db.delete_column('action_poll', 'vote_frequency')
    ...
    models = {
        ...
        'action.workbiddervote': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'voted_users'", 'to': "orm['auth.User']"}),
