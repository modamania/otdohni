...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Winner'
        db.create_table('action_winner', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fio', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('dt', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('action', self.gf('django.db.models.fields.related.ForeignKey')(related_name='winners', to=orm['action.Action'])),
        ))
        db.send_create_signal('action', ['Winner'])


    def backwards(self, orm):
        
        # Deleting model 'Winner'
        db.delete_table('action_winner')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 21, 13, 7, 52, 564197)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 21, 13, 7, 52, 563965)'}),
