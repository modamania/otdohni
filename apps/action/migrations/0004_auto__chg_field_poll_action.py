...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poll.action'
        db.alter_column('action_poll', 'action_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['action.Action']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Poll.action'
        raise RuntimeError("Cannot reverse this migration. 'Poll.action' and its values cannot be restored.")
