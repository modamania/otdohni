...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Poll.display_type'
        db.add_column('action_poll', 'display_type', self.gf('django.db.models.fields.CharField')(default='table', max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Poll.display_type'
        db.delete_column('action_poll', 'display_type')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 22, 14, 21, 0, 337933)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 22, 14, 21, 0, 337702)'}),
