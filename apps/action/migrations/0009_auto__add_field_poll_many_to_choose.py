...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Poll.many_to_choose'
        db.add_column('action_poll', 'many_to_choose', self.gf('django.db.models.fields.CharField')(default='ALL', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Poll.many_to_choose'
        db.delete_column('action_poll', 'many_to_choose')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 20, 43, 54, 500216)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 20, 43, 54, 499973)'}),
