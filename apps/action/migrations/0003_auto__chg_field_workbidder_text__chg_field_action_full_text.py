...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkBidder.text'
        db.alter_column('action_workbidder', 'text', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'Action.full_text'
        db.alter_column('action_action', 'full_text', self.gf('tinymce.models.HTMLField')())


    def backwards(self, orm):
        
        # Changing field 'WorkBidder.text'
        db.alter_column('action_workbidder', 'text', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Action.full_text'
        db.alter_column('action_action', 'full_text', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'action.workbidder': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'user_likes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'})
        },
        'auth.group': {
