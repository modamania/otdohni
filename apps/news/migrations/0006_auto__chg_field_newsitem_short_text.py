...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('news_newsitem', 'short_text', self.gf('django.db.models.fields.CharField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'NewsItem.short_text'
        db.alter_column('news_newsitem', 'short_text', self.gf('django.db.models.fields.CharField')(max_length=250))
