...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsItem.num_comments'
        db.add_column('news_newsitem', 'num_comments', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsItem.num_comments'
        db.delete_column('news_newsitem', 'num_comments')
