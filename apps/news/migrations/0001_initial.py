...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('news_newsitem', (
            ...
            ('short_text', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ...
        # Adding M2M table for field tags on 'NewsItem'
        db.create_table('news_newsitem_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('newsitem', models.ForeignKey(orm['news.newsitem'], null=False)),
            ('tag', models.ForeignKey(orm['tagging.tag'], null=False))
        ))
        db.create_unique('news_newsitem_tags', ['newsitem_id', 'tag_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field tags on 'NewsItem'
        db.delete_table('news_newsitem_tags')
