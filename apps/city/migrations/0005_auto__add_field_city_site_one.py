...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'City.site_one'
        db.add_column('city_city', 'site_one', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='city', unique=True, null=True, to=orm['sites.Site']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'City.site_one'
        db.delete_column('city_city', 'site_one_id')
