...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_post', (
            ...
            ('ext_authors', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ext_authors_link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('is_published', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('pub_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, db_index=True)),
            ('short_text', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ...
        db.create_table('blog_post_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['blog.post'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('blog_post_sites', ['post_id', 'site_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('blog_post_sites')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 12, 18, 40, 44, 540430)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 12, 18, 40, 44, 540205)'}),
        ...
        'blog.post': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'blog'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['tagging.Tag']"}),
