...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('private_messages2_message', 'subject')


    def backwards(self, orm):
        
        # Adding field 'Message.subject'
        db.add_column('private_messages2_message', 'subject', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
