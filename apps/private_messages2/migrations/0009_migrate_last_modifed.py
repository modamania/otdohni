...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for chain in Chain.objects.all():
            chain.last_modifed = chain.last_message.sent_at
            chain.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 1, 25, 48, 664960)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 1, 25, 48, 664730)'}),
