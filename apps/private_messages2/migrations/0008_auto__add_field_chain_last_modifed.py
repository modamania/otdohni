...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chain.last_modifed'
        db.add_column('private_messages2_chain', 'last_modifed', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1900, 1, 1)), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Chain.last_modifed'
        db.delete_column('private_messages2_chain', 'last_modifed')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 1, 25, 15, 993133)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 4, 1, 25, 15, 992908)'}),
