...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Chain.subject'
        db.delete_column('private_messages2_chain', 'subject')


    def backwards(self, orm):
        
        # Adding field 'Chain.subject'
        db.add_column('private_messages2_chain', 'subject', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 18, 6, 9, 237331)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 18, 6, 9, 237097)'}),
        ...
        'private_messages2.chain': {
            'Meta': {'ordering': "['-last_modifed', '-id']", 'object_name': 'Chain'},
            'have_read': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modifed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
