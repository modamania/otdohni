...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoursquarePhoto.is_published'
        db.add_column('place_foursquarephoto', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FoursquarePhoto.is_published'
        db.delete_column('place_foursquarephoto', 'is_published')
