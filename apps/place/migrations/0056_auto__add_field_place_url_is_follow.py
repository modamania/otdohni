...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.url_is_follow'
        db.add_column('place_place', 'url_is_follow', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.url_is_follow'
        db.delete_column('place_place', 'url_is_follow')
