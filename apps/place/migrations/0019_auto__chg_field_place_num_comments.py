...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.num_comments'
        db.alter_column('place_place', 'num_comments', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Place.num_comments'
        db.alter_column('place_place', 'num_comments', self.gf('django.db.models.fields.IntegerField')())
