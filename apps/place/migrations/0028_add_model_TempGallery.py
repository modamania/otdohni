...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TempGallery'
        db.create_table('place_tempgallery', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(related_name='temps', to=orm['place.PlaceGallery'])),
            ('image', self.gf('django.db.models.fields.FilePathField')(max_length=200, path='/', null=True, blank=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('place', ['TempGallery'])


    def backwards(self, orm):
        
        # Deleting model 'TempGallery'
        db.delete_table('place_tempgallery')
    ...
    models = {
        'place.place': {
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'places'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['sites.Site']"}),
        ...
        'place.tempgallery': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.FilePathField', [], {'max_length': '200', 'path': "'/'", 'null': 'True', 'blank': 'True'}),
