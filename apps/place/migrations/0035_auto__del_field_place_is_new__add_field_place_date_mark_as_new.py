...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Place.is_new'
        db.delete_column('place_place', 'is_new')

        # Adding field 'Place.date_mark_as_new'
        db.add_column('place_place', 'date_mark_as_new', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Place.is_new'
        db.add_column('place_place', 'is_new', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Place.date_mark_as_new'
        db.delete_column('place_place', 'date_mark_as_new')
    ...
    models = {
        'place.place': {
            ...
            'date_mark_as_new': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
