...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.manual_changed'
        db.add_column('place_place', 'manual_changed', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.manual_changed'
        db.delete_column('place_place', 'manual_changed')
