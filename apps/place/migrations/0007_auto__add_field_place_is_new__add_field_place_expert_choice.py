...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.expert_choice'
        db.add_column('place_place', 'expert_choice', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Place.expert_choice'
        db.delete_column('place_place', 'expert_choice')
