...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PlaceCategory.ordering'
        #db.delete_column('place_placecategory', 'ordering')

        # Deleting field 'Place.rate_in_category'
        db.delete_column('place_place', 'rate_in_category')

        # Adding field 'Place.main_address'
        db.add_column('place_place', 'main_address', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PlaceCategory.ordering'
        #raise RuntimeError("Cannot reverse this migration. 'PlaceCategory.ordering' and its values cannot be restored.")
        ...
        # Deleting field 'Place.main_address'
        db.delete_column('place_place', 'main_address')
