...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'FoursquareID'
        db.delete_table('place_foursquareid')

        # Adding field 'PlaceAddress.fsid'
        db.add_column('place_placeaddress', 'fsid', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'FoursquareID'
        db.create_table('place_foursquareid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fsid', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('address', self.gf('django.db.models.fields.related.OneToOneField')(related_name='foursquare', unique=True, to=orm['place.PlaceAddress'])),
        ))
        db.send_create_signal('place', ['FoursquareID'])

        # Deleting field 'PlaceAddress.fsid'
        db.delete_column('place_placeaddress', 'fsid')
    ...
    models = {
        ...
        'place.placeaddress': {
            ...
            'fsid': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
