...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.hits'
        db.alter_column('place_place', 'hits', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Place.urlhits'
        db.alter_column('place_place', 'urlhits', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Place.hits'
        db.alter_column('place_place', 'hits', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Place.urlhits'
        db.alter_column('place_place', 'urlhits', self.gf('django.db.models.fields.IntegerField')(null=True))
