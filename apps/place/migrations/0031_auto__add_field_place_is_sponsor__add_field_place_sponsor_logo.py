...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.is_sponsor'
        db.add_column('place_place', 'is_sponsor', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Place.sponsor_logo'
        db.add_column('place_place', 'sponsor_logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.is_sponsor'
        db.delete_column('place_place', 'is_sponsor')

        # Deleting field 'Place.sponsor_logo'
        db.delete_column('place_place', 'sponsor_logo')
