...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaceAddress.city'
        db.add_column('place_placeaddress', 'city', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['city.City'], null=True, blank=True), keep_default=False)

        # Adding field 'PlaceAddress.lat'
        db.add_column('place_placeaddress', 'lat', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'PlaceAddress.lng'
        db.add_column('place_placeaddress', 'lng', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlaceAddress.city'
        db.delete_column('place_placeaddress', 'city_id')

        # Deleting field 'PlaceAddress.lat'
        db.delete_column('place_placeaddress', 'lat')

        # Deleting field 'PlaceAddress.lng'
        db.delete_column('place_placeaddress', 'lng')
    ...
    models = {
        ...
        'place.foursquareid': {
            'Meta': {'object_name': 'FoursquareID'},
            'fsid': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'foursquareid'", 'to': "orm['place.Place']"})
        },
