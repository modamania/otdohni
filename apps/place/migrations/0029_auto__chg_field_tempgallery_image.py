...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TempGallery.image'
        db.alter_column('place_tempgallery', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'TempGallery.image'
        db.alter_column('place_tempgallery', 'image', self.gf('django.db.models.fields.FilePathField')(path='/', max_length=200, null=True))
