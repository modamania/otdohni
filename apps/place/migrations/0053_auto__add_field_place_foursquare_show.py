...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.foursquare_show'
        db.add_column('place_place', 'foursquare_show', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.foursquare_show'
        db.delete_column('place_place', 'foursquare_show')
