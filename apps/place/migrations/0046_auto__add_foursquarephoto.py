...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FoursquarePhoto'
        db.create_table('place_foursquarephoto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='foursquare_photo', to=orm['place.Place'])),
            ('photo_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal('place', ['FoursquarePhoto'])


    def backwards(self, orm):
        
        # Deleting model 'FoursquarePhoto'
        db.delete_table('place_foursquarephoto')
