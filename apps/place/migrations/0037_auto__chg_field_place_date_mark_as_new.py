...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.date_mark_as_new'
        db.alter_column('place_place', 'date_mark_as_new', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Place.date_mark_as_new'
        db.alter_column('place_place', 'date_mark_as_new', self.gf('django.db.models.fields.DateTimeField')())
