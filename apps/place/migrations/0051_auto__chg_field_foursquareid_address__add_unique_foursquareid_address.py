...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FoursquareID.address'
        db.alter_column('place_foursquareid', 'address_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['place.PlaceAddress']))

        # Adding unique constraint on 'FoursquareID', fields ['address']
        db.create_unique('place_foursquareid', ['address_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FoursquareID', fields ['address']
        db.delete_unique('place_foursquareid', ['address_id'])

        # Changing field 'FoursquareID.address'
        db.alter_column('place_foursquareid', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['place.PlaceAddress']))
    ...
    models = {
        ...
        'place.foursquareid': {
            ...
            'address': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'foursquare'", 'unique': 'True', 'to': "orm['place.PlaceAddress']"}),
