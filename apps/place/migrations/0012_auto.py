...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field places on 'PlaceCategory'
        db.create_table('place_place_rate_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm['place.placecategory'], null=False)),
            ('place', models.ForeignKey(orm['place.place'], null=False)),
            ('rate', models.FloatField(max_length=10, default=1,editable=False)),
            ('num_votes', models.PositiveIntegerField(default=0,editable=False))
        ))
        db.create_unique('place_place_rate_categories', ['category_id', 'place_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field places on 'PlaceCategory'
        db.delete_table('place_place_rate_categories')
