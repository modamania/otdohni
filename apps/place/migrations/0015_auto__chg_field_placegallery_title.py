...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlaceGallery.title'
        db.alter_column('place_placegallery', 'title', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))


    def backwards(self, orm):
        
        # Changing field 'PlaceGallery.title'
        db.alter_column('place_placegallery', 'title', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))
