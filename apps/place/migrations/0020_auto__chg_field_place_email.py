...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('place_place', 'email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Place.email'
        db.alter_column('place_place', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
