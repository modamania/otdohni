...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Place.category_rate'
        db.delete_column('place_place', 'category_rate')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Place.category_rate'
        db.add_column('place_place', 'category_rate', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'place.placecategory': {
            ...
            'category_rate': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
