...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.num_comments'
        db.add_column('place_place', 'num_comments', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.num_comments'
        db.delete_column('place_place', 'num_comments')
