...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Place.kinohod_network'
        db.delete_column('place_place', 'kinohod_network')

        # Adding field 'Place.can_buy_tiket'
        db.add_column('place_place', 'can_buy_tiket', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Place.kinohod_network'
        db.add_column('place_place', 'kinohod_network', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Deleting field 'Place.can_buy_tiket'
        db.delete_column('place_place', 'can_buy_tiket')
