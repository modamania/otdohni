...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlaceAddress.fsid'
        db.alter_column('place_placeaddress', 'fsid', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'PlaceAddress.fsid'
        db.alter_column('place_placeaddress', 'fsid', self.gf('django.db.models.fields.CharField')(max_length=255))
