...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PlaceCategory.category_rate'
        db.delete_column('place_placecategory', 'category_rate')

        # Adding field 'PlaceCategory.category_mean'
        db.add_column('place_placecategory', 'category_mean', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PlaceCategory.category_rate'
        db.add_column('place_placecategory', 'category_rate', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Deleting field 'PlaceCategory.category_mean'
        db.delete_column('place_placecategory', 'category_mean')
    ...
    models = {
        ...
        'place.placecategory': {
            ...
            'category_mean': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
