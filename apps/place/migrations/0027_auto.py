...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sites on 'Place'
        db.create_table('place_place_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('place', models.ForeignKey(orm['place.place'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('place_place_sites', ['place_id', 'site_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field sites on 'Place'
        db.delete_table('place_place_sites')
