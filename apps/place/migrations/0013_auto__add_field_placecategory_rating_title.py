...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaceCategory.rating_title'
        db.add_column('place_placecategory', 'rating_title', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlaceCategory.rating_title'
        db.delete_column('place_placecategory', 'rating_title')
