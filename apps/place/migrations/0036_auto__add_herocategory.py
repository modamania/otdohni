...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HeroCategory'
        db.create_table('place_herocategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hero_category', to=orm['place.PlaceCategory'])),
            ('hero_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('place', ['HeroCategory'])


    def backwards(self, orm):
        
        # Deleting model 'HeroCategory'
        db.delete_table('place_herocategory')
