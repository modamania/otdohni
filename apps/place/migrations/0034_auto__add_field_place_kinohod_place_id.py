...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.kinohod_place_id'
        db.add_column('place_place', 'kinohod_place_id', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.kinohod_place_id'
        db.delete_column('place_place', 'kinohod_place_id')
