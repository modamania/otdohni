...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaceCategory.is_published'
        db.add_column('place_placecategory', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlaceCategory.is_published'
        db.delete_column('place_placecategory', 'is_published')
