...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaceCategory.ordering'
        db.add_column('place_placecategory', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True), keep_default=False)
