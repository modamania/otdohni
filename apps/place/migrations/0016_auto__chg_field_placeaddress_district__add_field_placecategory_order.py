...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlaceAddress.district'
        db.alter_column('place_placeaddress', 'district', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Adding field 'PlaceCategory.order'
        db.add_column('place_placecategory', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'PlaceAddress.district'
        db.alter_column('place_placeaddress', 'district', self.gf('django.db.models.fields.CharField')(max_length=12))

        # Deleting field 'PlaceCategory.order'
        db.delete_column('place_placecategory', 'order')
