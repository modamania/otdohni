...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.flash3d'
        db.alter_column('place_place', 'flash3d', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'Place.flash3d'
        db.alter_column('place_place', 'flash3d', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
