...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaceGallery.title'
        db.add_column('place_placegallery', 'title', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlaceGallery.title'
        db.delete_column('place_placegallery', 'title')
