...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('place_place', 'logo')

        # Adding field 'Place.hits'
        db.add_column('place_place', 'hits', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Place.logotype'
        db.add_column('place_place', 'logotype', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Place.logotype_alt'
        db.add_column('place_place', 'logotype_alt', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Place.photo_alt'
        db.add_column('place_place', 'photo_alt', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Place.urlhits'
        db.add_column('place_place', 'urlhits', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Place.logo'
        db.add_column('place_place', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Place.hits'
        db.delete_column('place_place', 'hits')

        # Deleting field 'Place.logotype'
        db.delete_column('place_place', 'logotype')

        # Deleting field 'Place.logotype_alt'
        db.delete_column('place_place', 'logotype_alt')

        # Deleting field 'Place.photo_alt'
        db.delete_column('place_place', 'photo_alt')

        # Deleting field 'Place.urlhits'
        db.delete_column('place_place', 'urlhits')
