...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlaceGallery.image'
        db.alter_column('place_placegallery', 'image', self.gf('django.db.models.fields.files.ImageField')(default=datetime.date(2012, 1, 11), max_length=100))


    def backwards(self, orm):
        
        # Changing field 'PlaceGallery.image'
        db.alter_column('place_placegallery', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
