...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('place_foursquareid', (
            ...
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(related_name='foursquareid', to=orm['place.PlaceAddress'])),
    ...
    models = {
        ...
        'place.foursquareid': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'foursquareid'", 'to': "orm['place.PlaceAddress']"}),
