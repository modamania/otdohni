...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field payments on 'Place'
        db.create_table('place_place_payments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('place', models.ForeignKey(orm['place.place'], null=False)),
            ('paymentsystem', models.ForeignKey(orm['payments.paymentsystem'], null=False))
        ))
        db.create_unique('place_place_payments', ['place_id', 'paymentsystem_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field payments on 'Place'
        db.delete_table('place_place_payments')
