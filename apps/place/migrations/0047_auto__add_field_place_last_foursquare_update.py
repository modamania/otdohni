...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.last_foursquare_update'
        db.add_column('place_place', 'last_foursquare_update', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.last_foursquare_update'
        db.delete_column('place_place', 'last_foursquare_update')
