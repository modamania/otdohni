...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'KinohodSeance'
        db.create_table('kinohod_kinohodseance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dt', self.gf('django.db.models.fields.DateTimeField')()),
            ('seance_id', self.gf('django.db.models.fields.TextField')()),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='kh_seances', to=orm['event.Event'])),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='kh_seances', to=orm['place.Place'])),
        ))
        db.send_create_signal('kinohod', ['KinohodSeance'])


    def backwards(self, orm):
        
        # Deleting model 'KinohodSeance'
        db.delete_table('kinohod_kinohodseance')
    ...
    models = {
        ...
        'event.occurrence': {
            ...
            'times_kinohod': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '288', 'null': 'True', 'blank': 'True'})
        },
        'kinohod.kinohodseance': {
            'Meta': {'object_name': 'KinohodSeance'},
            'dt': ('django.db.models.fields.DateTimeField', [], {}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'kh_seances'", 'to': "orm['event.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'kh_seances'", 'to': "orm['place.Place']"}),
            'seance_id': ('django.db.models.fields.TextField', [], {})
        },
        'place.place': {
